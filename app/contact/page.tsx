                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-stone-600 font-semibold">
                      {" "}
                      Sifarişlər və paketlər haqqında məlumat üçün
                    </p>
                    <p className="text-stone-600 mb-3">+994 70 241 00 13</p>

                    <p className="text-stone-600 font-semibold">
                      {" "}
                      Təklif, irad və rəhbərliklə əlaqə üçün
                    </p>
                    <p className="text-stone-600">+994 70 606 66 66</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="flex items-center text-stone-600">
                      ...
                      Əhmədli mts, Xətai rayonu Telnov 18A 
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === "success" && (
                  <div className="p-4 bg-green-50 text-green-700 rounded-lg">
                    Mesajınız uğurla göndərildi. Tezliklə sizinlə əlaqə
                    saxlayacağıq.
                  </div>
                )}
                ...
                {submitStatus === "error" && (
                  <div className="p-4 bg-red-50 text-red-700 rounded-lg">
                    Xəta baş verdi. Zəhmət olmasa bir az sonra yenidən cəhd
                    edin.
                  </div>
                )}
